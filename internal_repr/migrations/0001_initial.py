# Generated by Django 4.2.14 on 2024-08-13 01:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demographics', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='uid_case', to='internal_repr.uidsubjectdemographics')),
                ('description', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='uid_case', to='internal_repr.subjectdescription')),
                ('details_of_recovery', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='uid_case', to='internal_repr.location')),
                ...
                ('identification', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='uid_case', to='internal_repr.uidsubjectidentification')),
                ('location_found', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='uid_cases', to='internal_repr.location')),
                ...
                ('related_items', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='uid_case', to='internal_repr.subjectrelateditems')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='mp_case', to='internal_repr.subjectdescription')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition_of_remains', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recovery_details', to='internal_repr.conditionofremains')),
            ],
        ),
        migrations.CreateModel(
